    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          MaterialButton(
            child:
              Text("Bearbeiten", style: TextStyle(
                color: Colors.white,
              ),),
            onPressed: (){Navigator.pushNamed(context, EditFieldScreen.routeName);},
          ),
        ],
      ),
      body:
      Container(
        child:
          Column(
            children: [
              EasySearch( //von: https://pub.dev/packages/easy_search
...
Widget startAnalysis(context){
  return SizedBox(
    ...
    FloatingActionButton.extended(
      onPressed: (){Navigator.pushNamed(context, AnalysisStartScreen.routeName);},
      label: const Text('Bewertung starten', style: TextStyle(color: Colors.white),),
